...
const NewArrivals = () => {
  ...
  `;
    ...
    useEffect(() => {
        axios.get('http://localhost:3001/get-topSeller-products')
            .then(response => setNewArrival(response.data))
            .catch(error => console.error('Error fetching new arrival products:', error));
    }, []);
