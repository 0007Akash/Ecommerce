...
const Chill = () => {
    ...
    useEffect(() => {
        axios.get('https://ecommerce-jht1.onrender.com/get-products?section=Chillproof') // Replace with your API endpoint
            .then(response => {
    ...
    return (
        <div className="container mx-auto p-4">
            <h1 className="text-2xl font-bold mb-4">Chill-Proof Collection</h1>
